...
namespace SamplePWA.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SamplePWA.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<SamplePWA.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SamplePWA.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SamplePWA.Server.Models.ApplicationUser user)
        {
            try
            {
