...
namespace SamplePWA.Client.Pages
{
    public partial class EditEmployee
    {
        ...
        {
            employee = await SampleDBService.GetEmployeeByEmployeeId(employeeId:EmployeeID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SampleDBService.UpdateEmployee(employeeId:EmployeeID, employee);
