...
namespace SamplePWA.Client.Pages
{
    public partial class EditPurchaseOrderDetail
    {
        ...
        {
            purchaseOrderDetail = await SampleDBService.GetPurchaseOrderDetailByOrderDetailId(orderDetailId:OrderDetailID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SampleDBService.UpdatePurchaseOrderDetail(orderDetailId:OrderDetailID, purchaseOrderDetail);
