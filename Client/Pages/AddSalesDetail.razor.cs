...
{
    public partial class AddSalesDetail
    {
        [Inject]
        ...
        {
            salesDetail = new SamplePWA.Server.Models.SampleDB.SalesDetail();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SampleDBService.CreateSalesDetail(salesDetail);
